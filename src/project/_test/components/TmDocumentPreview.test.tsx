...
describe("TmDocumentPreview", () => {
  test("can render", async () => {
    await getRender();
    const button = screen.getByTestId("testBtnPrintAll");
    expect(button).toBeInTheDocument();
  });

  test("can change preview pages", async () => {
    await getRender();
    let button = screen.getByTestId("testBtnPreviousPage");
    expect(button).toBeInTheDocument();
    act(() => {
      fireEvent.click(button);
    });

    button = screen.getByTestId("testBtnNextPage");
    expect(button).toBeInTheDocument();
    act(() => {
      fireEvent.click(button);
    });
  ...
  test("can scale preview", async () => {
    await getRender();
    let button = screen.getByTestId("testBtnZoomIn");
    expect(button).toBeInTheDocument();
    act(() => {
      fireEvent.click(button);
    });

    button = screen.getByTestId("testBtnZoomOut");
    expect(button).toBeInTheDocument();
    act(() => {
      fireEvent.click(button);
    });

    button = screen.getByTestId("testBtnResetZoom");
    expect(button).toBeInTheDocument();
    act(() => {
      fireEvent.click(button);
    });
  ...
  test("can print preview", async () => {
    await getRender();

    let button = screen.getByTestId("testBtnPrintAll");
    expect(button).toBeInTheDocument();
    act(() => {
      fireEvent.click(button);
    });

    button = screen.getByTestId("testBtnPrint");
    expect(button).toBeInTheDocument();
    act(() => {
      fireEvent.click(button);
    });
  ...
  test("can exit", async () => {
    await getRender();
    const button = screen.getByTestId("testBtnExit");
    expect(button).toBeInTheDocument();
  ...
  //Testing hotkeys
  it("can use hotkey to print a specific document", async () => {
    await getRender();
    act(() => {
  ...
  it("can use hotkey to print a all documents", async () => {
    await getRender();
    act(() => {
  ...
  it("can use hotkey to scroll down on preview", async () => {
    await getRender();
    act(() => {
      fireEvent.keyDown(document, { key: "Down", altKey: true });
    });
  });

  it("can use hotkey to scroll up on preview", async () => {
    await getRender();
    act(() => {
      fireEvent.keyDown(document, { key: "Up", altKey: true });
    });
  });

  it("can use hotkey to scroll left on preview", async () => {
    await getRender();
    act(() => {
      fireEvent.keyDown(document, { key: "Left", altKey: true });
    });
  });

  it("can use hotkey to scroll right on preview", async () => {
    await getRender();
    act(() => {
      fireEvent.keyDown(document, { key: "Right", altKey: true });
    });
  });

  it("can use hotkey to goto next preview page", async () => {
    await getRender();
    act(() => {
  ...
  it("can use hotkey to goto previous preview page", async () => {
    await getRender();
    act(() => {
  ...
  it("can use hotkey to zoom in on preview", async () => {
    await getRender();
    act(() => {
  ...
  it("can use hotkey to zoom out on preview", async () => {
    await getRender();
    act(() => {
      fireEvent.keyDown(document, { key: "-", altKey: true });
    });
  ...
  it("can use hotkey to reset zoom on preview", async () => {
    await getRender();
    act(() => {
...
const getRender = async () => {
  await act(async () => {
    render(
      <TmDocumentPreview
        data={base64}
        printAllCallBack={mockPrint}
        printCallBack={mockPrint}
        showPrintAllButton={true}
        showPrintButton={true}
        testId="test"
        disablePrintButton={true}
        exitCallBack={mockExit}
        width={800}
      />
    );
  })
